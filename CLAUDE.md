...
<<<<<<< HEAD **Maintained By:** Lane Melancon — Onn Grid, LLC **Client:** Dr. Brandon Crawford — NeuroSolution Center of Austin **Last Updated:** 2026-07-28 **GitHub Repo:** `https://github.com/LaneMelancon/nsatx-store-shopify-theme` ======= <<<<<<< HEAD **Maintained By:** Lane Melancon — Onn Grid, LLC **Client:** Dr. Brandon Crawford — NeuroSolution Center of Austin **Last Updated:** 2026-07-15 **GitHub Repo:** `https://github.com/LaneMelancon/nsatx-store-shopify-theme` ======= **Maintained By:** Lane Melancon — Onn Grid, LLC **Client:** Dr. Brandon Crawford — NeuroSolution Center of Austin **Last Updated:** 2026-07-28 **GitHub Repo:** `https://github.com/LaneMelancon/nsatx-store-shopify-theme`
...
<<<<<<< HEAD This repo is kept independent (as a submodule of `nsatx-store`) specifically to support Shopify's GitHub integration — the Shopify GitHub app requires a standalone repo to sync theme code directly to a store without manual imports. This repo contains two branches 'main' and 'dev'. All changes, updated, and additions are only comitted and pushed to the 'dev' branch and reviewed before squash-merging into the 'main' branch. The 'main' branch is connected to the Shopify store via the Github connection and is published as the live theme (changes to the 'main' branch automatically get published to the live site). The 'dev' branch is connected to the Shopify store as a draft theme where changes are made locally or within the Shopify theme editor. ======= <<<<<<< HEAD This repo is kept independent (as a submodule of `nsatx-store`) specifically to support Shopify's GitHub integration — the Shopify GitHub app requires a standalone repo to sync theme code directly to a store without manual imports. ======= This repo is kept independent (as a submodule of `nsatx-store`) specifically to support Shopify's GitHub integration — the Shopify GitHub app requires a standalone repo to sync theme code directly to a store without manual imports. This repo contains two branches 'main' and 'dev'. All changes, updated, and additions are only comitted and pushed to the 'dev' branch and reviewed before squash-merging into the 'main' branch. The 'main' branch is connected to the Shopify store via the Github connection and is published as the live theme (changes to the 'main' branch automatically get published to the live site). The 'dev' branch is connected to the Shopify store as a draft theme where changes are made locally or within the Shopify theme editor.
...
- Keep this markdown file up to date with changes or additions related to the Shopify Theme <<<<<<< HEAD
